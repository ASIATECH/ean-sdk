...
//itineraryId
  ...
  function sendOrder() {
  	url = config.ean.bookReservation+"?"+qs.stringify(config.settings)+"&"+qs.stringify(data)
...
// confirmationNumber
    ...
    url = config.ean.cancelReservation+"?"+qs.stringify(config.settings)+"&"+qs.stringify(data)
    request.post(url,function(err,response,body){
